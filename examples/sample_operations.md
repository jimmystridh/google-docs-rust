...
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager create
```
...
```bash
~/.claude/skills/google-docs-rust/scripts/docs_manager read 1abc-xyz-document-123
```
...
```bash
~/.claude/skills/google-docs-rust/scripts/docs_manager structure 1abc-xyz-document-123
```
...
echo '{
  ...
  "index": 1
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager insert
```
...
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager append
```
...
echo '{
  ...
  "replace": "Q4 2024",
  "match_case": false
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager replace
```
...
echo '{
  ...
  "end_index": 22,
  "bold": true
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager format
```
...
echo '{
  "document_id": "1abc-xyz-document-123",
  "index": 500
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager page-break
```
...
echo '{
  ...
  "start_index": 1000,
  "end_index": 1500
}' | ~/.claude/skills/google-docs-rust/scripts/docs_manager delete
```
...
~/.claude/skills/google-docs-rust/scripts/docs_manager structure new_doc_abc
...
~/.claude/skills/google-docs-rust/scripts/docs_manager read proposal_doc_123 > current_state.json
...
create_from_template() {
  ...
  }' | ~/.claude/skills/google-docs-rust/scripts/docs_manager create | jq -r '.document_id')
...
~/.claude/skills/google-docs-rust/scripts/drive_manager move \
  --file-id "$doc_id" \
  --folder-id "team_folder_id_xyz"

# Step 5: Share with team
~/.claude/skills/google-docs-rust/scripts/drive_manager share \
  --file-id "$doc_id" \
  --email team@company.com \
  --role writer

# Step 6: Generate PDF for archive
~/.claude/skills/google-docs-rust/scripts/drive_manager download \
  --file-id "$doc_id" \
...
~/.claude/skills/google-docs-rust/scripts/docs_manager read doc_abc_123

# Step 2: Get structure for reference points
~/.claude/skills/google-docs-rust/scripts/docs_manager structure doc_abc_123
...
~/.claude/skills/google-docs-rust/scripts/docs_manager read doc_abc_123 > backup.json
...
~/.claude/skills/google-docs-rust/scripts/docs_manager read doc_abc
# ... format operation ...
~/.claude/skills/google-docs-rust/scripts/docs_manager read doc_abc
...
~/.claude/skills/google-docs-rust/scripts/docs_manager read doc_abc > state.json
~/.claude/skills/google-docs-rust/scripts/docs_manager structure doc_abc > structure.json
...
~/.claude/skills/google-docs-rust/scripts/docs_manager structure doc_abc
