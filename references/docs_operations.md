...
Complete reference for all Google Docs operations available in the docs_manager script.
...
**Example**:
```bash
scripts/docs_manager read 1abc-xyz-document-id-123
```
...
**Example**:
```bash
scripts/docs_manager structure 1abc-xyz-document-id-123
```
